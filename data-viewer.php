...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['url']) && isset($_POST['tool']) && $_POST['tool'] === 'data') {
    ...
    try {
        if ($videoId) {
            ...
            $channelUrlForThumb = "https://www.googleapis.com/youtube/v3/channels?part=snippet&id={$channelIdForThumb}&key=" . YOUTUBE_API_KEY;
            ...
            $dislikeCount = number_format($statistics['dislikeCount'] ?? 0);
            $favoriteCount = number_format($statistics['favoriteCount'] ?? 0);
                        ...
                        <div class="data-grid">
                            ...
                            <div class="data-item">
                                ...
                                <div class="data-value">
                                    <img src="' . $channelThumbnail . '" class="channel-thumbnail" alt="Channel Thumbnail">
                                    ' . htmlspecialchars($snippet['channelTitle']) . '
                                </div>
                            </div>
                            <div class="data-item">
                            ...
                            <div class="data-item">
                             ...
                             <div class="data-item">
                                <div class="data-label">Dislikes</div>
                                <div class="data-value">' . $dislikeCount . '</div>
                            </div>
                             <div class="data-item">
                                <div class="data-label">Favorites</div>
                                <div class="data-value">' . $favoriteCount . '</div>
                            </div>
                            <div class="data-item">
                            ...
                            <div class="data-item">
                             ...
                             <div class="data-item">
                                <div class="data-label">Definition</div>
                                <div class="data-value">' . ucfirst($contentDetails['definition']) . '</div>
                            </div>
                             <div class="data-item">
                                <div class="data-label">Licensed Content</div>
                                <div class="data-value">' . ($contentDetails['licensedContent'] ? 'Yes' : 'No') . '</div>
                            </div>
                        </div>
                        <div class="result-item">
                            <div class="result-label">Description</div>
                            <div class="result-value">' . nl2br(htmlspecialchars($snippet['description'])) . '</div>
                        </div>
                        <div class="result-item">
                            <div class="result-label">Tags</div>
                            <div class="result-value">' . (isset($snippet['tags']) ? implode(', ', $snippet['tags']) : 'No tags') . '</div>
                        </div>
                        <div class="result-item">
